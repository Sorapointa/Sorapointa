...
private val questDataLoader =
    DataLoader<List<QuestData>>("./ExcelBinOutput/QuestExcelConfigData.json")

val questData get() = questDataLoader.data

@Serializable
data class QuestData(
    @JsonNames("subId", "SubId")
    val subId: Int,
    @JsonNames("mainId", "MainId")
    val mainId: Int,
    @JsonNames("order", "Order")
    val order: Int,
    ...
    val finishCond: List<QuestParam>,
    @JsonNames("failCond", "FailCond")
    val failCond: List<QuestParam>,
    @JsonNames("beginExec", "BeginExec")
    val beginExec: List<QuestExecParam>,
    @JsonNames("finishExec", "FinishExec")
    val finishExec: List<QuestExecParam>,
    @JsonNames("failExec", "FailExec")
    val failExec: List<QuestExecParam>
) {
    @Serializable
...
enum class LogicType(val value: Int) {
    LOGIC_NONE(0),
    LOGIC_AND(1),
    LOGIC_OR(2),
    LOGIC_NOT(3),
...
enum class QuestTrigger(val value: Int) {
    QUEST_COND_NONE(0),
